...
public class HttpURLConnectionTelemetryClientCN {
        ...
        try {
             if(pingType == TelemetryChinaPingBuilder.TYPE){
                ...
                if(info[7].equals("top_site")) {
                    ...
                    connectionCN = this.openConnectionConnection("https://m.g-fox.cn/cnrocket.gif?" + "clientID=" + clientID + "&device=" + device + "&type=" + info[7] + "&documentID=", pathCN[3] + "&version=" + pathCN[6] + pathCN[7] + "lite");
                }
