...
public class TelemetryCN {
    ...
    public TelemetryCN(TelemetryConfiguration configuration, TelemetryStorage storage,
                     TelemetryClientCN client, TelemetryScheduler scheduler) {
    ...
    public TelemetryCN addPingBuilder(TelemetryPingBuilder builder) {
    ...
    public TelemetryCN queuePing(final String pingType) {
    ...
    public TelemetryCN queueEvent(final TelemetryEvent event) {
        if (!configuration.isCollectionEnabled()) {
            return this;
        }
    ...
    public TelemetryCN recordSessionEnd(Function0<Unit> onFailure) {
        if (!configuration.isCollectionEnabled()) {
            return this;
        }
    ...
    public TelemetryCN recordSessionEnd() {
     ...
     */
    public TelemetryCN recordSearch(@NonNull  String location, @NonNull String identifier) {
        if (!configuration.isCollectionEnabled()) {
            return this;
        }
     ...
     */
    public TelemetryCN recordActiveExperiments(List<String> activeExperimentsIds) {
        if (!configuration.isCollectionEnabled()) {
            return this;
        }
     ...
     *                    experiment.
     */
    public TelemetryCN recordExperiments(Map<String, Boolean> experiments) {
        if (!configuration.isCollectionEnabled()) {
            return this;
        }
    ...
    public TelemetryCN setDefaultSearchProvider(DefaultSearchMeasurement.DefaultSearchEngineProvider provider) {
        if (!pingBuilders.containsKey(TelemetryCorePingBuilder.TYPE)) {
            throw new IllegalStateException("This configuration does not contain a core ping builder");
        }
